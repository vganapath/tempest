...
TEMPEST_DIR=${TEMPEST_DIR:-$(pwd)}
KEYSTONE_SERVICE_PROTOCOL="http"
#KEYSTONE_SERVICE_HOST="10.204.217.70"
KEYSTONE_SERVICE_HOST=${KEYSTONE_SERVICE_HOST:-127.0.0.1}
#PUBLIC_NETWORK_NAME="public_net"
PUBLIC_NETWORK_NAME=${PUBLIC_NETWORK_NAME:-public_net}
#PUBLIC_NETWORK_RI_FQ_NAME="default-domain:admin:$PUBLIC_NETWORK_NAME:$PUBLIC_NETWORK_NAME"
PUBLIC_NETWORK_RI_FQ_NAME=${PUBLIC_NETWORK_RI_FQ_NAME:-"default-domain:admin:$PUBLIC_NETWORK_NAME:$PUBLIC_NETWORK_NAME"}
#PUBLIC_NETWORK_RT="10003"
PUBLIC_NETWORK_RT=${PUBLIC_NETWORK_RT:-10003}
#ROUTER_ASN="64510"
ROUTER_ASN=${ROUTER_ASN:-64510}
#API_SERVER_IP="10.204.217.22"
API_SERVER_IP=${API_SERVER_IP:-127.0.0.1}
#API_SERVER_HOST_USER="admin"
API_SERVER_HOST_USER=${API_SERVER_HOST_USER:-root}
API_SERVER_HOST_PASSWORD=${API_SERVER_HOST_PASSWORD:-c0ntrail123}
#PUBLIC_NETWORK_SUBNET="10.204.216.64/29"
PUBLIC_NETWORK_SUBNET=${PUBLIC_NETWORK_SUBNET:-10.1.1.0/24}
#HTTP_IMAGE_PATH="http://10.204.216.51/images/cirros/cirros-0.3.1-x86_64-uec.tar.gz"
HTTP_IMAGE_PATH=${HTTP_IMAGE_PATH:-http://10.204.216.51/images/cirros/cirros-0.3.1-x86_64-uec.tar.gz}
...
OPENSTACKRC=${OPENSTACKRC:-/etc/contrail/openstackrc}
source ${OPENSTACKRC}
